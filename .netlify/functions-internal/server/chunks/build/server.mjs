import { defineComponent, shallowRef, h, resolveComponent, inject, computed, toValue, mergeProps, unref, ref, watch, createVNode, resolveDynamicComponent, withCtx, renderSlot, createBlock, openBlock, toDisplayString, toRef, useSlots, createCommentVNode, getCurrentInstance, provide, cloneVNode, createElementBlock, useAttrs, mergeModels, useModel, createTextVNode, isRef, hasInjectionContext, onServerPrefetch, nextTick, defineAsyncComponent, useSSRContext, Suspense, Fragment, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, l as parseQuery, m as klona, n as defuFn, o as defu, q as hasProtocol, t as joinURL, w as withQuery, v as withTrailingSlash, x as withoutTrailingSlash, y as isScriptProtocol, z as isEqual, A as sanitizeStatusCode, B as getContext, C as withLeadingSlash, D as parseURL, c as createError$1, $ as $fetch$1, E as baseURL, F as createHooks, G as executeAsync, H as encodeParam, I as encodePath, J as toRouteMatcher, K as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Clk43qA8.mjs')
  }
];
...
const cloudinaryRuntime$aVF9_45q5Ivmvjdu8KVhqt1vl4inv6XJbzsh7p_45UagAH8 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage: getImage$1
}, Symbol.toStringTag, { value: "Module" }));
...
const ipxRuntime$K3ux37k5jfgSKww9jQlHiHmoJVwa_Q_3yv32HxmElYM = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["cloudinary"]: { provider: cloudinaryRuntime$aVF9_45q5Ivmvjdu8KVhqt1vl4inv6XJbzsh7p_45UagAH8, defaults: { "baseURL": "https://res.cloudinary.com/augalo/image/upload/" } },
    ["ipx"]: { provider: ipxRuntime$K3ux37k5jfgSKww9jQlHiHmoJVwa_Q_3yv32HxmElYM, defaults: {} }
  }
};
...
const NuxtImg = Object.assign(_sfc_main$d, { __name: "NuxtImg" });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(NuxtImg)), mergeProps({
                role: "img",
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(NuxtImg)), mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C2ITwNC-.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DZbChbrn.mjs'));
...
export { NuxtImg as N, _export_sfc as _, __nuxt_component_0$1 as a, useAppConfig as b, useButtonGroup as c, useComponentIcons as d, entry$1 as default, _sfc_main$e as e, _sfc_main$b as f, useLocale as g, _sfc_main$8 as h, useSeoMeta as i, useToast as j, __nuxt_component_4 as k, tv as t, useHead as u };
